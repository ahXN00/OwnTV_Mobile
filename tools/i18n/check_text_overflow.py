...
# Every module whose Kotlin ships to users. :app is the only one here; the core library's Kotlin
# is gated by the identical check in ahXN00/OwnTV_Core.
SOURCE_ROOTS = [ROOT / "app/src/main/java"]
